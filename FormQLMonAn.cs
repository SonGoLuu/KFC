...
namespace KFC
{
    public partial class FormQLMonAn : UserControl
    {
        ...
        private void FormQLMonAn_Load(object sender, EventArgs e)
        {
           dgvSanPham.DataSource = bus_sanpham.getAllSanPham("monan");
        }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            DTO_SanPham sp = new DTO_SanPham(masp, tensp, "monan", slton);
        ...
        {
            if (txtFind.Text != "") dgvSanPham.DataSource = bus_sanpham.findSP(txtFind.Text, "monan");
            else dgvSanPham.DataSource = bus_sanpham.getAllSanPham("monan");
        }
